...
目前專案已完成「題目研究、競賽規則整理、宮廟資料蒐集、功能規格草案、Demo 資料、RAG 知識庫、10 頁簡報、Demo 影片與可部署 Demo App」。目前重點已從功能開發轉為送件品質檢查、格式合規、授權聲明與連結驗證。
...
- 10 頁投稿簡報 PDF 已產出版面送件版，仍需確認團隊名稱、指導老師與聯絡資訊是否完整。
- 3 分鐘 Demo 影片已產出本機 MP4，仍需上傳 YouTube 並確認連結可由未登入帳號開啟。
- 技術使用切結書、個資同意書、不侵權保證書、提案切結書仍需填寫與全員簽署。
...
- 保守送件目標：2026-09-20 23:59，Asia/Taipei。
- 日期風險：本地舊筆記曾記錄 2026-09-24 17:00；2026-09-13 複核時，多所學校轉公告寫初審截止為 2026-09-20 23:59，而 Accupass 活動頁顯示活動期間到 2026-09-24 17:00。正式上傳前需以官方投件頁最後確認。
