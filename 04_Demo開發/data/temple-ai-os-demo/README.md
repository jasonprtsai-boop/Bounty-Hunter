# Temple AI OS Demo 範例資料包

整理日期：2026-08-05

這包資料是 Demo sample data，不是萬春宮官方營運資料。
...
- 可展示完整服務流程：LINE 問答、活動卡、LIFF 報名、報名成功、後台統計。
- 對外說明時標示為 Demo sample data。
- 不放真實個資、不放真實付款帳號、不聲稱為萬春宮正式報名系統。
