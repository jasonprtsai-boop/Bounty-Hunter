    ...
    return [
        {
            ...
            "title": "主殿參拜導覽",
            "category": "參拜動線",
            "summary": "示範以 LIFF 呈現主殿參拜資訊、開放資料來源與現場注意事項。",
            "cultural_note": "正式導覽內容需由廟方確認；Demo 僅示範資訊呈現與互動流程。",
            "image_url": image_url,
        ...
        },
        {
            ...
            "title": "沿革與文化牆",
            "category": "文化導覽",
            "summary": "示範整理廟宇沿革、公開資料摘要與導覽卡片，供 LINE 內開啟。",
            "cultural_note": "歷史內容應以廟方正式資料為準，Demo 不代表官方正式公告。",
            "image_url": image_url,
    ...
    return [
        {
            ...
            "cultural_note": "此為文化體驗 Demo，不代表神意判斷或命運預測。",
        ...
        },
        {
            ...
            "cultural_note": "AI 僅提供文化化、保守的文字解讀，不做斷言。",
        ...
        },
        {
            ...
            "cultural_note": "此籤詩是 Demo 內容，用於展示互動介面。",
            "reminder": "AI 不應被視為神明代言或命運判斷工具。",
            "status": "published",
        },
    ]
